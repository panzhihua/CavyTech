...
import com.basecore.util.cache.ExternalOverFroyoUtils;
import com.basecore.util.cache.ExternalUnderFroyoUtils;
...
public class DownloadBitmapHandler extends ResizerBitmapHandler
{
	...
	protected void clearCacheInternal()
	{
		synchronized (mHttpDiskCacheLock)
		{
			if (mHttpDiskCache != null && !mHttpDiskCache.isClosed())
			{
				...
				{
					LogUtil.getLogger().e("clearCacheInternal - " + e);
				}
				mHttpDiskCache = null;
	...
	protected void closeCacheInternal()
	{
		synchronized (mHttpDiskCacheLock)
		{
			if (mHttpDiskCache != null)
			{
				...
				{
					LogUtil.getLogger().e("closeCacheInternal - " + e);
				}
			}
		}
	}
	...
	private Bitmap processBitmap(String data)
	{
		...
		synchronized (mHttpDiskCacheLock)
		{
			...
			if (mHttpDiskCache != null)
			{
				...
				{
					LogUtil.getLogger().e("processBitmap - " + e);
			...
			OutputStream outputStream)
	{
		...
		{
			LogUtil.getLogger().e("Error in downloadBitmap - " + e);
		} finally
		{
