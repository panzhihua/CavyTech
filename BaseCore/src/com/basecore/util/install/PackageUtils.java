package com.basecore.util.install;
...
import com.basecore.util.install.ShellUtils.CommandResult;
...
public class PackageUtils {
	...
	public static Intent queryActivitiesForPackage(Context context,
			String packageName) {
	...
	public static final int install(Context context, String filePath) {
		L.d(TAG, "" + PackageUtils.isSystemApplication(context));
		L.d(TAG, "" + ShellUtils.checkRootPermission());
		L.d(TAG, "" + ShellUtils.isRootSystem());
