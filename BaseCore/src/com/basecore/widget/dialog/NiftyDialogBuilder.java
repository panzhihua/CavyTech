...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    public void showMsgLinearLayout(int show){

        mLinearLayoutMsgView.setVisibility(show);
    }

    public void showBtnLinearLayout(int show){

        LinearLayout btnLinearLayout = (LinearLayout)mDialogView.findViewById(R.id.btnPanel);
        btnLinearLayout.setVisibility(show);
    }
}
