...
public class ToolDateTime {
	...
	/** 日期格式：yyyy-MM-dd **/
	public static final String DFYYYYPMMPDD = "yyyy.MM.dd";
	 ...
	 * @return 时间差(秒)
	 */
	public static long getSubNowTime(Date dt) {

		long time = gainCurrentDate().getTime() - dt.getTime();
	 ...
	 * @return 月份差
	 */
	public static int getDifMonthNowTime(int year) {

		Calendar c = Calendar.getInstance();//首先要获取日历对象
		int nowYear = c.get(Calendar.YEAR); // 获取当前年份
		int nowMonth = c.get(Calendar.MONTH);

		int difMonth = (nowYear - year) * 12 + nowMonth;
