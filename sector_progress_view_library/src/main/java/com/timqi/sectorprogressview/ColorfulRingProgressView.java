...
public class ColorfulRingProgressView extends View {
    ...
    public ColorfulRingProgressView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mStrokeWidth = a.getDimensionPixelSize(R.styleable.ColorfulRingProgressView_progressStrokeWidth, dp2px(21));
            mIsShowPath  = a.getBoolean(R.styleable.ColorfulRingProgressView_showPath, false);
            mPathColor = a.getColor(R.styleable.ColorfulRingProgressView_pathColor, Color.BLUE);
    ...
    private void initPathPaint(){
        ...
        mPathPaint.setAntiAlias(true); // 抗锯齿功能
        mPathPaint.setStyle(Paint.Style.STROKE);
        mPathPaint.setColor(mPathColor);
        int dashLen= 10;
        DashPathEffect effects = new DashPathEffect(new float[]{dashLen,dashLen,dashLen,dashLen},1);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mIsShowPath) {
            canvas.drawCircle(mOval.centerX(), mOval.centerY(), mOval.width() / 2, mPathPaint);
        }
