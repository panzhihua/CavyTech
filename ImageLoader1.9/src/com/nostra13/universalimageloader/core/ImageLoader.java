...
public class ImageLoader {
	...
	public void displayImage(String uri, ImageAware imageAware,int defaultImage) {
		displayImage(uri, imageAware,defaultImage, null, null, null);
	}
	...
	public void displayImage(String uri, ImageAware imageAware,int defaultImage, ImageLoadingListener listener) {
		displayImage(uri, imageAware, defaultImage,null, listener, null);
	}
	...
	public void displayImage(String uri, ImageAware imageAware,int defaultImage, DisplayImageOptions options) {
		displayImage(uri, imageAware, defaultImage,options, null, null);
	}
	...
	public void displayImage(String uri, ImageAware imageAware,int defaultImage,DisplayImageOptions options,
			ImageLoadingListener listener) {
		displayImage(uri, imageAware,defaultImage, options, listener, null);
	}
	...
	public void displayImage(String uri, ImageAware imageAware, int defaultImage,DisplayImageOptions options,
		...
		if (TextUtils.isEmpty(uri)) {
			...
			if (options.shouldShowImageForEmptyUri()) {
				...
				imageAware.setImageDrawable(configuration.resources.getDrawable(defaultImage));
			}
	...
	public void displayImage(String uri, ImageView imageView,int defaultImage) {
		displayImage(uri, new ImageViewAware(imageView),defaultImage, null, null, null);
	}
	...
	public void displayImage(String uri, ImageView imageView,int defaultImage,DisplayImageOptions options) {
		displayImage(uri, new ImageViewAware(imageView), defaultImage,options, null, null);
	}
	...
	public void displayImage(String uri, ImageView imageView, int defaultImage,ImageLoadingListener listener) {
		displayImage(uri, new ImageViewAware(imageView),defaultImage, null, listener, null);
	}
	...
	public void displayImage(String uri, ImageView imageView, int defaultImage,DisplayImageOptions options,
			ImageLoadingListener listener) {
		displayImage(uri, imageView,defaultImage,options, listener, null);
	}
	...
	public void displayImage(String uri, ImageView imageView, int defaultImage,DisplayImageOptions options,
			ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
		displayImage(uri, new ImageViewAware(imageView), defaultImage,options, listener, progressListener);
	}
