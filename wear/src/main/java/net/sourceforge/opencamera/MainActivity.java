...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		registerReceiver(clickedTakePhotoReceiver, new IntentFilter(TAKE_PHOTO_ACTION));
...
*/
	...
	protected void onDestroy() {
		...
		unregisterReceiver(clickedTakePhotoReceiver);
	    super.onDestroy();
	}
    ...
    void layoutUI() {
		...
		}
		{
			...
			view.setVisibility(View.GONE);  // todo
	...
	private BroadcastReceiver clickedTakePhotoReceiver = new BroadcastReceiver() {

		@Override
		public void onReceive(Context context, Intent intent) {
			String action = intent.getAction();
			if(action == TAKE_PHOTO_ACTION) {
    ...
    void cameraSetup() {
    	...
    	SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
		{
			...
			zoomControls.setVisibility(View.GONE);  // todo
		}
		{
			if( MyDebug.LOG )
