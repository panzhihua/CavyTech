...
public class StepService extends Service {
    ...
    public void onCreate() {
     ...
     //   Toast.makeText(this, getText(R.string.stepsCountStarted), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onDestroy() {
      ...
      //  Toast.makeText(this, getText(R.string.stepsCountStopped), Toast.LENGTH_SHORT).show();
    }
    ...
    private void showNotification() {
        ...
        pedometerIntent.setComponent(new ComponentName(this, StepCountActivity.class));
