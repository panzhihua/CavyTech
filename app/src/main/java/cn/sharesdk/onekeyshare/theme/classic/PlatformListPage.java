...
public class PlatformListPage extends PlatformListFakeActivity implements View.OnClickListener {
	...
	private void initPageView() {
		...
		try {
			XmlResourceParser xrp = getContext().getResources().getXml(R.drawable.bt_text_color_white);
			cl = ColorStateList.createFromXml(getContext().getResources(), xrp);
		} catch (Exception ex) {
		}

		if (cl != null) {
			btnCancel.setTextColor(cl);
		}
