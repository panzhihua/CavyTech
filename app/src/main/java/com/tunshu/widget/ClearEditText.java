...
/**
 * Created by ShadowNight on 2015/9/24.
 */
...
//    private int errorDrawableId = R.drawable.user_error;
    ...
    public ClearEditText(Context context, AttributeSet attrs, int defStryle) {
...
//        a.recycle();
    ...
    private void init() {
        ...
        setStatus(status);
        del_btn = mContext.getResources().getDrawable(R.drawable.icon_delete_normal);
        del_btn_down = mContext.getResources().getDrawable(R.drawable.icon_delete_normal);
        addListeners();
