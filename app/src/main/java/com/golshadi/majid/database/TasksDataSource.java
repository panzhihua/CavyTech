...
public class TasksDataSource {
    ...
    public void initDowningData(){
        // 进入APP后把状态初始化为暂停状态
        String query;
        query = "update "+TABLES.TASKS+" set "+TASKS.COLUMN_STATE + "=" + SqlString.Int(TaskStates.PAUSED) + " where(" + TASKS.COLUMN_STATE + "<>"
             + SqlString.Int(TaskStates.DOWNLOAD_FINISHED) + " and " + TASKS.COLUMN_STATE + "<>" + SqlString.Int(TaskStates.END) + ")";
